...
`https://inference.jocatagrid.in/ModelGateway/v1/chat/completions`
...
- `CUSTOM_LLM_API_BASE`: Endpoint base URL (default: `https://inference.jocatagrid.in/ModelGateway/v1`).
